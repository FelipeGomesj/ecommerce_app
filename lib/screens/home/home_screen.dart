          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      fillColor: _focusNode[0].hasFocus ? Colors.white :  const Color.fromRGBO(213, 213, 213, 0.5),
                      hintText: 'Pesquisar'.i18n, hintStyle: const TextStyle(
                    fontSize: 18,
                  ),
              ...
              Padding(
                ...
                child: Text('Categorias'.i18n, style: const TextStyle(
            ...
            SingleChildScrollView(
              ...
              SizedBox(
                ...
                child: GridView(gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 8, mainAxisSpacing: 8,
                ),
                   padding: const EdgeInsets.only(bottom: 60, left: 8, right: 8, top: 4),
                  children: const [
                    Card(
