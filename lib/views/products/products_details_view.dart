...
class ProductsDetailsScreen extends StatefulWidget {
  const ProductsDetailsScreen({super.key, required this.productModel, this.shoppingCart});
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) =>  CartScreen()) ),
                child: const Icon(
                  ...
                  builder: (context, sum, child ) => Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Spacer(),
                        Text(formatPrice(_productPriceSum.value),
                          style:  const TextStyle(
                ...
                children: [
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        shoppingCartController.addProductToCart(product: widget.productModel, amount: _countNotifier.value);
